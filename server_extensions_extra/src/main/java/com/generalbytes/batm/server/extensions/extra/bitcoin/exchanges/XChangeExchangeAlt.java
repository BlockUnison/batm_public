...
import org.knowm.xchange.alt.ExchangeFactory;
...
import org.knowm.xchange.alt.dto.account.AccountInfo;
...
import org.knowm.xchange.alt.service.account.AccountService;
import org.knowm.xchange.alt.service.marketdata.MarketDataService;
...
public abstract class XChangeExchangeAlt implements IExchangeAdvanced, IRateSourceAdvanced {
    ...
    public XChangeExchangeAlt(ExchangeSpecification specification, String preferredFiatCurrency) {
